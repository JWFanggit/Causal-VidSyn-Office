...
def main(
    ...
    *_, config = inspect.getargvalues(inspect.currentframe())
    ...
    train_dataset = DADA2KS3_double(root_path=r".../CAPDATA", interval=1, phase="train")
    val_dataset = DADA2KS3_double(root_path=r".../CAPDATA", interval=1, phase="val")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="./configs/lora_training_stage0.yaml")
